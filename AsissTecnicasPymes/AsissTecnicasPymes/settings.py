"""
Django settings for AsissTecnicasPymes project.
...
SECRET_KEY = 'django-insecure-p#doegu5t1!g-g9#758y6*oq^fe#1lm!w@cfs4f#(jg_5@x%!4'
...
WSGI_APPLICATION = 'AsissTecnicasPymes.wsgi.application'
